...
export const TILE_TYPE_COLORS: Record<TileType, number> = {
  ...
  [TileType.GrasslandMountain]: 0xD6EB9C,
  [TileType.DesertLand]: 0xF2E6A0,
  [TileType.DesertForest]: 0xEEDD70,
  [TileType.DesertMountain]: 0xF2E6A0,
  [TileType.TundraLand]: 0xCDA09E,
  [TileType.TundraForest]: 0xB06F96,
  [TileType.TundraMountain]: 0x834FA3,
  [TileType.TaigaLand]: 0x5FB698,
  [TileType.TaigaForest]: 0x4A9A8A,
  [TileType.TaigaMountain]: 0x66867C,
  [TileType.RainforestLand]: 0xB0D25D,
  [TileType.RainforestForest]: 0x638D1C,
