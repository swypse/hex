...
import { TERRAIN_ATLAS_FRAMES, TERRAIN_ATLAS_CELL_W, TERRAIN_ATLAS_CELL_H } from '../src/game/terrainAtlasData.gen';
import { TERRAIN_TILE_FILES, TERRAIN_FOG_FILE } from '../src/render/terrainAtlas';
...
describe('terrain atlas loader', () => {
  ...
  beforeEach(async () => {
    ...
    vi.resetModules();
    atlas = await import('../src/render/terrainAtlas');
  });
