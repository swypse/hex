...
- **Money** — each owned village produces `max(0, 3 + level × 2 − upkeep)`, where upkeep is the maintenance of the
  units the village raised: warrior 1, archer/shield/rider 2, swordsman 3, knight 4, catapult 5 per turn; ships cost
  2 / 3 / 4 per turn by level. Income never goes below 0.
